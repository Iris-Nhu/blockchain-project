...
const VerifyProduct = () => {
  ...
  // Giả lập gọi API/Blockchain lấy dữ liệu
  useEffect(() => {
    // Trong thực tế, dùng ethers.js gọi Smart Contract tại đây
    setTimeout(() => {
      // Giả sử ID = 123 là có thật
      if (id === '123' || id === '1') {
        setProduct({
          id: id,
          ...
          image: 'https://cdn-icons-png.flaticon.com/512/2933/2933116.png', // Ảnh minh họa
          certificates: [
    ...
    }, 1500); // Delay 1.5s cho giống thật
  }, [id]);
